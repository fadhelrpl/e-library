...
<div class="max-w-4xl mx-auto mb-18">
    <div class="overflow-hidden rounded-lg shadow-lg max-h-[400px]">
        ...
        @else
        <img src="https://picsum.photos/1200/400" alt="Co   ver Buku" class="w-full h-96 object-cover">
        @endif
    </div>
    <div class="text-center mt-4">
        ...
        <a href="/hall/book/{{ $books[0]->slug }}" class="mt-4 inline-block px-4 py-2 bg-blue-500 text-white rounded-lg hover:bg-blue-600">Read more</a>
    </div>
</div>
...
<div class="container mx-auto px-4">
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="relative">
                @if ($book->cover)
                <img src="{{ Storage::url($book->cover) }}" alt="Cover Buku" class="w-full h-60 object-cover">
                @else
                <img src="https://picsum.photos/480/300" alt="Cover Buku" class="w-full h-60 object-cover">
                @endif
            ...
            <div class="p-4">
                ...
                <div class="flex items-center text-gray-600 text-sm gap-4 mt-2">
                    ...
                    <span class="flex items-center gap-1"><i class="fa-solid fa-clock text-yellow-300"></i>
                        {{ $book->published_at ? \Carbon\Carbon::parse($book->published_at)->diffForHumans() : 'Belum Terbit' }}</span>
                </div>
